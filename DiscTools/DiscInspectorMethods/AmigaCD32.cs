...
namespace DiscTools
{
    ...
    {
        public static DiscInspector ScanCD32(string cuePath)
        {
            ...
            if (DISC.isIso == true)
            {
                ...
                if (DISC.Data.ISOData.SystemIdentifier.Contains("CDTV"))
                {
                    DISC.DetectedDiscType = DetectedDiscType.AmigaCD32;
                    DISC.DiscTypeString = DISC.DetectedDiscType.ToString();
                    return DISC;
                }
            }
